  ...
  <div className="flex flex-col p-5">
    ...
    <div className="flex flex-col gap-5 text-black">
        ...
        <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
                <label htmlFor="bantuan" className="text-xs font-medium">Jumlah Nominal</label>
                <Input type="number" min={10000} id="bantuan"
                value={bantuan} onChange={(e) => setBantuan(e.target.value)}
                placeholder="Malang"/>
            </div>
            <div className="flex flex-col gap-2">
                <label htmlFor="bantuan" className="text-xs font-medium">Metode Transfer</label>
                <Input type="text" id="bantuan"
                value={bantuan} onChange={(e) => setBantuan(e.target.value)}
